...
GAME_HEIGHT = 700
SPACE_SIZE = 50
BODY_PARTS = beleptetes.jelszo_hossz()
SNAKE_COLOR = "#00FF00"
FOOD_COLOR = "#FF0000"
...
def score_szemleles(score):
    speed = 600 # Alapértelmezett sebesség, ha nincs más eset

    for i in range(score):
        if score >=1:  # A sebesség ne csökkenjen 50 alá
            speed=speed//2
            print(speed)
    if score >= 4:
        game_over()
